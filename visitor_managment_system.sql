...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2020 at 07:03 AM
...
(3, 'Marketing', 'Marketing', '2020-11-07 08:07:09', NULL),
(4, 'HR', 'HR', '2020-11-07 08:08:47', NULL),
(5, 'Production', 'Production', '2020-11-09 12:41:59', NULL),
(6, 'Accounting', 'Accounting', '2020-11-09 12:42:43', NULL),
(7, 'Purchase', 'Purchase', '2020-11-09 12:43:17', NULL);
...
CREATE TABLE `visitor` (
  ...
  `meet_person_name` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `department_id` int(10) DEFAULT NULL,
  `reason_to_meet` text COLLATE utf8_unicode_ci,
  `visitor_enter_time` datetime DEFAULT NULL,
  `visitor_outing_remark` text COLLATE utf8_unicode_ci,
  `out_time` datetime DEFAULT NULL,
  `visitor_status` enum('In','Out') COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
