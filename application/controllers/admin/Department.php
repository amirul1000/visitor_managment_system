...
$updated_at = "";
		...
		$params = array(
					 'department_name' => html_escape($this->input->post('department_name')),
...
$this->db->or_like('department_name', $key, 'both');
...
$this->db->or_like('updated_at', $key, 'both');
	...
	function export($export_type='CSV'){
	  if($export_type=='CSV'){	
		   ...
		   $header = array("Id","Department Name","Description","Created At","Updated At"); 
		   fputcsv($file, $header);
